	...
	public static SessionFactory getSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				settings.put(Environment.URL, "jdbc:mysql://localhost:3306/temp?useSSL=false");
				...
				configuration.addAnnotatedClass(ClassReport.class);
				...
				configuration.addAnnotatedClass(ClassStandard.class);
